...
def process_yahoo(name: str, train_file_path: str, test_file_path: str) -> None:
    """
...
if __name__ == '__main__':
    process_yahoo('Yahoo-Music', './raw/train.csv', './raw/test.csv')
